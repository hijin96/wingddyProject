    ...
    <div id="storecart">
        <div>
            <jsp:include page="../sideBar/sideBar.jsp" />
             <div class="main-content">  <br><br><br><br><br><br><br>
                                                    ...
                                                    <c:forEach var="cart" items="${cart }">
                                                            <tr>
                                                                ...
                                                                <td class="thumbnail-img">
                                                                    <a href="#"> <img class="img-fluid" src="${contextPath}/${s.filePath}/${s.changeName}" alt="" /></a>
                                                                </td>
                                                                <td class="name-pr">
                                                                    <a href="#"> ${s.spName }  </a>
                                                                </td>
                                    ...
                                    <div class="row my-5">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            ...
                                            <input value="수정하기" type="submit" name="Update Cart">
                                                ...
                                                <input value="구매하기" type="submit" name="buyCart" onclick="buyCart();">
